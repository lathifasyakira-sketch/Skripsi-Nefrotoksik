...
if __name__ == "__main__":
    if 0: # Kode untuk Memfilter
        ...
        filter_keyword="Ureum Darah"
        )
    
        print("selesai")

    if 1: # Kode untuk menggabungkan
        excel_file_template = "LT {Bulan} ureum.xlsx"
        glob_pattern = f"/Users/lathifasyakira/Desktop/SKRIPSI/kurasiureum/{excel_file_template.replace('{Bulan}', '*')}"
